...
# En ASR
python3 examples/speech_to_text/prep_covost_data.py \
  --data-root ../datasets/CoVoST2 --vocab-type char --src-lang mn
# ST
python3 examples/speech_to_text/prep_covost_data.py \
  --data-root ../datasets/CoVoST2 --vocab-type char \
  --src-lang mn --tgt-lang en
```

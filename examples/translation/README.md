...
python3 fairseq_cli/preprocess.py --source-lang de --target-lang en \
...
python3 fairseq_cli/preprocess.py --source-lang fr --target-lang en \
...
CUDA_VISIBLE_DEVICES=0 python3 fairseq_cli/train.py data-bin/iwslt17.de_fr.en.bpe16k/ \
    --max-epoch 50 \

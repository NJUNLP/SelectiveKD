...
class TransformerModel(TransformerModelBase):
    ...
    def add_args(cls, parser):
        ...
        parser.add_argument(
            ...
            type=str,
            help="use parameters of a checkpoint"
        )
...
@register_model_architecture("transformer", "transformer_12enc_1dec")
def transformer_efficient(args):
    args.encoder_layers = getattr(args, "encoder_layers", 12)
    args.decoder_layers = getattr(args, "decoder_layers", 1)
    base_architecture(args)

@register_model_architecture("transformer", "transformer_6enc_1dec")
def transformer_efficient_tiny(args):
    args.encoder_layers = getattr(args, "encoder_layers", 6)
    args.decoder_layers = getattr(args, "decoder_layers", 1)
    base_architecture(args)

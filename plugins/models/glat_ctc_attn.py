...
from plugins.models.glat import GLATDecoder, GLATEncoder
import logging
...
@register_model("glat_ctc_attn")
class GlatCTCAttn(FairseqNATModel):
    ...
    def build_encoder(cls, args, tgt_dict, embed_tokens):
        ...
        pretrained = getattr(args, "load_from_checkpoint", "")
        if pretrained != "":
...
@register_model_architecture(
    "glat_ctc_attn", "glat_ctc_attn_6e6d512"
)
...
@register_model_architecture(
    "glat_ctc_attn", "glat_ctc_attn_base"
)
